...
namespace gazebo
{
	...
	std::string ending_tag = "<plugin name='lmaze_controller_plugin' filename='/homes/gkumar/rl/PrivateModelDevelopment1/build/liblmaze_controller_plugin.so'> \
	        ...
	        for (int i=0; i < MAZE_SIZE; i++){ // Outer-Most Loop
	            ...
	            for (int j=0; j < MAZE_SIZE; j++){
	                if (line.at(j) == '|' || line.at(j) == '_'){
	                    resource_uri = "/homes/gkumar/rl/PrivateModelDevelopment1/models/cube.dae";
	                ...
	                tempSDF = tempSDF
	                    ...
	                    resource_uri = "/homes/gkumar/rl/PrivateModelDevelopment1/models/cubePit.dae";
		...
		if(goal_i != -1 && goal_j != -1 ){
            ...
            + link_tag_Outer2
	            ...
	            + colission_tag_until_pose
                    ...
                    + " 0 0 0"
	            + colission_tag_until_uri
	            	+ "/homes/gkumar/rl/PrivateModelDevelopment1/models/cube.dae"
	            + colission_tag_until_scale
